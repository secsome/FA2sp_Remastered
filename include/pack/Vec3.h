...
class Vec3 {
 public:
  ...
  inline T dot(const Vec3& other) const { return v[0] * other.v[0] + v[1] * other.v[1] + v[2] * other.v[2]; }

  inline T length() const { return static_cast<T>(sqrt(squaredLength())); }

  inline T squaredLength() const { return dot(*this); }
  ...
  inline bool equals(const Vec3& other, T epsilon = T(0.001)) {
    return fabs(v[0] - other.v[0]) <= epsilon && fabs(v[1] - other.v[1]) <= epsilon &&
           fabs(v[2] - other.v[2]) <= epsilon;
  }
...
class Matrix3_4 {
 public:
  ...
  Vec3<T> operator*(const Vec3<T> v) const {
    ...
    auto y = v[1];
    auto z = v[2];
    return Vec3<T>(x * m[0][0] + y * m[0][1] + z * m[0][2] + m[0][3], x * m[1][0] + y * m[1][1] + z * m[1][2] + m[1][3],
  ...
  static Matrix3_4 scale(const Vec3<T> v) { return Matrix3_4({{v.x(), 0, 0, 0}, {0, v.y(), 0, 0}, {0, 0, v.z(), 0}}); }
