...
void CTriggers::OnSelchangeTrigger() {
  ...
  if (m_Event.SetCurSel(0) != CB_ERR) OnSelchangeEvent();
  ...
  if (m_Action.SetCurSel(0) != CB_ERR) OnSelchangeAction();
...
void CTriggers::OnSelchangeEvent() {
  ...
  for (i = 0; i < m_EventType.GetCount(); i++) {
    ...
    TruncSpace(tmp);
    if (tmp == EventType) m_EventType.SetCurSel(i);
  }
...
void CTriggers::OnSelchangeAction() {
  ...
  for (i = 0; i < m_ActionType.GetCount(); i++) {
    ...
    TruncSpace(tmp);
    if (tmp == ActionType) m_ActionType.SetCurSel(i);
  }
...
void CTriggers::OnEditchangeHouse() {
  ...
  ini.sections["Triggers"].values[(LPCTSTR)CurrentTrigger] =
      SetParam(ini.sections["Triggers"].values[(LPCTSTR)CurrentTrigger], 0, (LPCTSTR)house);
}
...
void CTriggers::OnChangeName() {
  ...
  ini.sections["Triggers"].values[(LPCTSTR)CurrentTrigger] =
      SetParam(ini.sections["Triggers"].values[(LPCTSTR)CurrentTrigger], 2, (LPCTSTR)m_Name);
...
void CTriggers::OnChangeFlag1() {
  ...
  ini.sections["Triggers"].values[(LPCTSTR)CurrentTrigger] =
      SetParam(ini.sections["Triggers"].values[(LPCTSTR)CurrentTrigger], 3, (LPCTSTR)m_F1);
}
...
void CTriggers::OnChangeFlag2() {
  ...
  ini.sections["Triggers"].values[(LPCTSTR)CurrentTrigger] =
      SetParam(ini.sections["Triggers"].values[(LPCTSTR)CurrentTrigger], 4, (LPCTSTR)m_F2);
}
...
void CTriggers::OnChangeFlag3() {
  ...
  ini.sections["Triggers"].values[(LPCTSTR)CurrentTrigger] =
      SetParam(ini.sections["Triggers"].values[(LPCTSTR)CurrentTrigger], 5, (LPCTSTR)m_F3);
}
...
void CTriggers::OnChangeFlag4() {
  ...
  ini.sections["Triggers"].values[(LPCTSTR)CurrentTrigger] =
      SetParam(ini.sections["Triggers"].values[(LPCTSTR)CurrentTrigger], 6, (LPCTSTR)m_F4);
}
...
void CTriggers::OnChangeFlag5() {
  ...
  ini.sections["Triggers"].values[(LPCTSTR)CurrentTrigger] =
      SetParam(ini.sections["Triggers"].values[(LPCTSTR)CurrentTrigger], 7, (LPCTSTR)m_F5);
}
...
void CTriggers::OnEditchangeTrigger2() {
  ...
  ini.sections["Triggers"].values[(LPCTSTR)CurrentTrigger] =
      SetParam(ini.sections["Triggers"].values[(LPCTSTR)CurrentTrigger], 1, (LPCTSTR)trg);
}
...
void CTriggers::OnEditchangeEventtype() {
  ...
  ini.sections["Events"].values[(LPCTSTR)CurrentTrigger] =
      SetParam(ini.sections["Events"].values[(LPCTSTR)CurrentTrigger], pos, (LPCTSTR)eventtype);
...
void CTriggers::OnEditchangeEventparam1() {
  ...
  ini.sections["Events"].values[(LPCTSTR)CurrentTrigger] =
      SetParam(ini.sections["Events"].values[(LPCTSTR)CurrentTrigger], pos, (LPCTSTR)param1);
}
...
void CTriggers::OnEditchangeEventparam2() {
  ...
  ini.sections["Events"].values[(LPCTSTR)CurrentTrigger] =
      SetParam(ini.sections["Events"].values[(LPCTSTR)CurrentTrigger], pos, (LPCTSTR)param2);
}
...
void CTriggers::OnEditchangeActiontype() {
  ...
  ini.sections["Actions"].values[(LPCTSTR)CurrentTrigger] =
      SetParam(ini.sections["Actions"].values[(LPCTSTR)CurrentTrigger], pos, (LPCTSTR)actiontype);
...
void CTriggers::OnEditchangeActionwaypoint() {
  ...
  ini.sections["Actions"].values[(LPCTSTR)CurrentTrigger] =
      SetParam(ini.sections["Actions"].values[(LPCTSTR)CurrentTrigger], pos, (LPCTSTR)waypoint);
}
...
void CTriggers::OnEditchangeActionparam1() {
  ...
  ini.sections["Actions"].values[(LPCTSTR)CurrentTrigger] =
      SetParam(ini.sections["Actions"].values[(LPCTSTR)CurrentTrigger], pos, (LPCTSTR)p1);
}
...
void CTriggers::OnEditchangeActionparam2() {
  ...
  ini.sections["Actions"].values[(LPCTSTR)CurrentTrigger] =
      SetParam(ini.sections["Actions"].values[(LPCTSTR)CurrentTrigger], pos, (LPCTSTR)p2);
}
...
void CTriggers::OnEditchangeActionparam3() {
  ...
  ini.sections["Actions"].values[(LPCTSTR)CurrentTrigger] =
      SetParam(ini.sections["Actions"].values[(LPCTSTR)CurrentTrigger], pos, (LPCTSTR)p3);
}
...
void CTriggers::OnEditchangeActionparam4() {
  ...
  ini.sections["Actions"].values[(LPCTSTR)CurrentTrigger] =
      SetParam(ini.sections["Actions"].values[(LPCTSTR)CurrentTrigger], pos, (LPCTSTR)p4);
}
...
void CTriggers::OnEditchangeActionparam5() {
  ...
  ini.sections["Actions"].values[(LPCTSTR)CurrentTrigger] =
      SetParam(ini.sections["Actions"].values[(LPCTSTR)CurrentTrigger], pos, (LPCTSTR)p5);
}
...
void CTriggers::OnEditchangeActionparam6() {
  ...
  ini.sections["Actions"].values[(LPCTSTR)CurrentTrigger] =
      SetParam(ini.sections["Actions"].values[(LPCTSTR)CurrentTrigger], pos, (LPCTSTR)p6);
}
...
void CTriggers::OnDeleteevent() {
  ...
  int posc = 1 + v * 3;
  int i;
  for (i = 0; i < 3; i++) data = SetParam(data, pos + i, GetParam(data, posc + i));
...
void CTriggers::OnDeletetrigger() {
  ...
  if (MessageBox("Do you really want to delete this trigger? Don´t forget to delete the attached tag (important!)",
                 "Delete trigger", MB_YESNO) == IDNO)
    return;
...
void CTriggers::OnAddtrigger() {
  ...
  if (MessageBox("Trigger created. If you want to create a simple tag now, press Yes. The tag will be called "
                 "New tag"
                 ", you should name it like the trigger (after you have set up the trigger).",
                 "Trigger created", MB_YESNO)) {
