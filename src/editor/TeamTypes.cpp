...
void CTeamTypes::OnSelchangeTeamtypes() {
  ...
  if (yuri_mode) m_MindControlDecision = sec.values["MindControlDecision"];
...
void CTeamTypes::OnDeleteteamtype() {
  ...
  if (m_TeamTypes.GetCurSel() != -1) {
    int res = MessageBox(
        "Are you sure that you want to delete the selected team-type? If you delete it, don´t forget to delete any "
        "reference to the team-type.",
        "Delete team-type", MB_YESNO);
    if (res == IDNO) return;
...
void CTeamTypes::OnKillfocusVeteranlevel() { OnEditchangeVeteranlevel(); }

void CTeamTypes::OnKillfocusHouse() { OnEditchangeHouse(); }

void CTeamTypes::OnKillfocusTechlevel() { OnEditchangeTechlevel(); }

void CTeamTypes::OnKillfocusGroup() { OnEditchangeGroup(); }

void CTeamTypes::OnKillfocusWaypoint() { OnEditchangeWaypoint(); }

void CTeamTypes::OnKillfocusScript() { OnEditchangeScript(); }
...
void CTeamTypes::OnKillfocusTag() { OnEditchangeTag(); }
...
void CTeamTypes::OnKillfocusTransportwaypoint() { OnEditchangeTransportwaypoint(); }
...
void CTeamTypes::OnKillfocusMindcontroldecision() { OnEditchangeMindcontroldecision(); }
