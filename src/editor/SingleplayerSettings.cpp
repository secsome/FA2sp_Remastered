...
void CSingleplayerSettings::UpdateDialog() {
  ...
  if (sec.values.find("Intro") != sec.values.end()) m_Intro.SetWindowText(sec.values["Intro"]);
  if (sec.values.find("Brief") != sec.values.end()) m_Brief.SetWindowText(sec.values["Brief"]);
  if (sec.values.find("Win") != sec.values.end()) m_Win.SetWindowText(sec.values["Win"]);
  if (sec.values.find("Lose") != sec.values.end()) m_Lose.SetWindowText(sec.values["Lose"]);
  if (sec.values.find("Action") != sec.values.end()) m_Action.SetWindowText(sec.values["Action"]);
  if (sec.values.find("PostScore") != sec.values.end()) m_PostScore.SetWindowText(sec.values["PostScore"]);
  if (sec.values.find("PreMapSelect") != sec.values.end()) m_PreMapSelect.SetWindowText(sec.values["PreMapSelect"]);
  ...
  if (sec.values.find("TimerInherit") != sec.values.end()) m_TimerInherit.SetWindowText(sec.values["TimerInherit"]);
  if (sec.values.find("FillSilos") != sec.values.end()) m_FillSilos.SetWindowText(sec.values["FillSilos"]);
